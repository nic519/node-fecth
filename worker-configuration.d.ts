/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dd7e25e66400275102c2c6837589d1d0)
...
// Pages Functions 类型定义
interface PagesFunction<T = any> {
	(context: EventContext<T, any, any>): Response | Promise<Response>;
}
