...
export function ConfigSidebar({
	...
	return (
		<aside className="fixed inset-y-0 left-0 z-50 w-72 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-2xl border-r border-border/40 flex flex-col transition-all duration-300 shadow-2xl shadow-black/5">
			{/* Header Section */}
